...
class Action:
    def __init__(self, filter, cams, nt_interface, referrer):
...
class StartFilter(Action):
    def __init__(self, filter, cams, nt_interface, referrer):
        super().__init__(filter, cams, nt_interface, referrer)
    ...
    def MakeChild(self):
        return AsyncSetHeight(self.filter, self.cams, self.nt_interface, 6, self.referrer)  # IMPORTANT: change


class AsyncSetHeight(Action):
    def __init__(self, filter, cams, nt_interface, referrer, height):
        super().__init__(filter, cams, nt_interface, referrer)
        '''
        0:Floor
        1:portal
    ...
    def MakeChild(self):
        if self.referrer == 'auto':
            return DriveToLocation(self.filter, self.cams, self.nt_interface, [0, 0, 0], self.referrer)


class DriveToLocation(Action):
    def __init__(self, filter, cams, nt_interface, location, referrer):
        super().__init__(filter, cams, nt_interface, referrer)
    ...
    def MakeChild(self):
        if self.referrer == 'auto':
            return AwaitSetHeight(self.filter, self.cams, self.nt_interface, self.referrer)
...
class AwaitSetHeight(Action):
    ...
    def MakeChild(self):
        if self.referrer == "auto":
            return Drop(self.filter, self.cams, self.nt_interface, self.referrer)  # IMPORTANT: change
...
class Drop(Action):
    ...
    def MakeChild(self):
        if self.referrer == "auto":
            return GetOnStation(self.filter, self.cams, self.nt_interface, self.referrer)  # IMPORTANT: change
...
class GetOnStation(Action):
    ...
    def MakeChild(self):
        return AutoBalance(self.filter, self.cams, self.nt_interface, self.referrer)
...
class AutoBalance(Action):
    ...
    def ShouldEnd(self):
        return self.nt_interface.IsTeleop()
