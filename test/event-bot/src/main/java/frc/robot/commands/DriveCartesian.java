...
public class DriveCartesian extends CommandBase {
    ...
    public void execute() {
        ...
        if (Math.abs(xSquare) > DrivetrainConst.JoystickDeadzone || Math.abs(ySquare) > DrivetrainConst.JoystickDeadzone || Math.abs(zSquare) > DrivetrainConst.JoystickDeadzone) {
